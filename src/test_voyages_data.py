...
def test_get_all_voyages():
    voyages = VoyageData(VoyageData.read_voyages_from_disk(file_name='test_data/voyages.csv'))
...
def test_find_voyage_by_id():
    voyages = VoyageData(VoyageData.read_voyages_from_disk(file_name='test_data/voyages.csv'))
    assert voyages.find_voyage_by_id("35d7ba70-3c2c-47de-90c8-0baf92b2dff8").destination == "Destination 1"


def test_make_recurring_voyage_daily():
    voyages = VoyageData(VoyageData.read_voyages_from_disk(file_name='test_data/voyages.csv'))
    voyage = voyages.find_voyage_by_id("35d7ba70-3c2c-47de-90c8-0baf92b2dff8")
    voyages.make_recurring_voyage(voyage, 1, datetime.fromisoformat("2023-06-30T22:07:46"))
...
def test_make_recurring_voyage_daily_no_change():
    voyages = VoyageData(VoyageData.read_voyages_from_disk(file_name='test_data/voyages.csv'))
    voyage = voyages.find_voyage_by_id("35d7ba70-3c2c-47de-90c8-0baf92b2dff8")
    voyages.make_recurring_voyage(voyage, 1, datetime.fromisoformat("2023-06-26T22:07:46"))
    all_voyages = voyages.get_all_voyages()
...
def test_make_recurring_voyage_every_three_days():
    voyages = VoyageData(VoyageData.read_voyages_from_disk(file_name='test_data/voyages.csv'))
    voyage = voyages.find_voyage_by_id("35d7ba70-3c2c-47de-90c8-0baf92b2dff8")
    voyages.make_recurring_voyage(voyage, 3, datetime.fromisoformat("2023-07-26T22:07:46"))
    all_voyages = voyages.get_all_voyages()
...
def test_make_recurring_voyage_weekly():
    ...
    voyages.make_recurring_voyage(voyage, 7, datetime.fromisoformat("2024-05-10T00:32:31"))
    all_voyages = voyages.get_all_voyages()
...
def test_make_recurring_voyage_biweekly():
    voyages = VoyageData(VoyageData.read_voyages_from_disk(file_name='test_data/voyages.csv'))
    voyage = voyages.find_voyage_by_id("13e7f26f-e8d4-48fe-a7d7-e22dd9b3a6a6")
    voyages.make_recurring_voyage(voyage, 14, datetime.fromisoformat("2024-05-10T00:32:31"))
    all_voyages = voyages.get_all_voyages()
...
def test_make_recurring_voyage_every_thirty_days():
    ...
    voyages.make_recurring_voyage(voyage, 30, datetime.fromisoformat("2025-08-23T22:09:04"))
    all_voyages = voyages.get_all_voyages()
